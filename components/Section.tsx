...
<div className={`grid grid-cols-1 grid-rows-2 p-4 w-full h-full md:grid-cols-2 md:grid-rows-1 items-center ${cs} md:h-[32rem]  text-[1.2em]`}>

<div className={ ` w-full  h-[90%]  md:w-60% md:h-[60%] justify-self-center  ${cscild} `}>

 <Image src={imgsrc} alt="img" className="w-full h-[80%] md:h-full object-cover rounded-xl 
